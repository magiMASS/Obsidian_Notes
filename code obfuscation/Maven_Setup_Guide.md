...
- Builds the Core artifact
- Deploys artifacts to the internal repository
...
- Builds the Base project
- Downloads Core artifacts from the repository
- Never deploys artifacts
...
The Base project must **NOT** contain:
